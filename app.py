...
def read_csv_data(year, file_name):
    conn = start_db(DB_HOST, DB_USER, DB_PASSWORD)
    file_merged_name = year + "VAERS" + file_name
    ...
    with open(file_path, 'r') as f:
        ...
        execute_many_data(conn, record_list, 'reports')
...
def read_csv_vaccine(year, file_name):
    ...
    with open(file_path, 'r') as f:
        ...
        execute_many_vax(conn, record_list, 'vaccine')
...
def main(year):
    read_csv_data(year, 'DATA.csv')
    read_csv_vaccine(year, 'VAX.csv')
